        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <HeadingCenter toptitle="Our Latest" bottomtitle="News & Blogs" />
              <div className={styles["content"]}>
                <p>
                  Follow our latest blogs on signage solutions to stay
                  up-to-date on industry trends, best practices, and inspiration
              ...
              <div className={styles["articles-page-slider"]}>
                <Slider {...settings}>
                  {blogList.slice(0, 5).map((list, index) => {
                    return (
                      <div key={index}>
                        <div className={styles["Articles-page"]}>
                          <div className={styles["own-main-container"]}>
                            ...
                            <div className={styles["date-location"]}>
                              ...
                              <p className={styles["get_data"]}>{list.date}</p>
                            </div>
                            ...
                            <div className={styles["own-desc-main"]}>
                              ...
                              <a
                                onClick={(e) => handleChangePost(e, list.id)}
                                className={styles["own-btn"]}
                              >
                                <FaChevronRight />
                              </a>
                            </div>
